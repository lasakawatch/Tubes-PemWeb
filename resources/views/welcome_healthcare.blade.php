    ...
    <body class="bg-gradient-to-br from-blue-50 to-green-50 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <div class="space-y-4 mb-8">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900">💊 Konsultasi Online 24/7</h3>
                                <p class="text-gray-600">Dapatkan konsultasi dengan dokter berpengalaman kapan pun Anda membutuhkan</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900">📅 Booking Appointment</h3>
                                <p class="text-gray-600">Jadwalkan pemeriksaan kesehatan Anda dengan mudah dan cepat</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900">📋 Rekam Medis Digital</h3>
                                <p class="text-gray-600">Akses riwayat kesehatan Anda dengan aman dan terpercaya</p>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Right Column - Visual -->
                <div class="relative">
                    <div class="bg-gradient-to-br from-blue-100 to-green-100 rounded-3xl p-8 shadow-2xl">
                        <div class="text-center mb-8">
                            ...
                            <h2 class="text-2xl font-bold text-blue-600 mb-2">Rekam Medis Digital</h2>
                            <p class="text-gray-600">Akses riwayat kesehatan Anda kapan saja</p>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition">
                                ...
                                <p class="text-center font-semibold text-gray-700">Konsultasi 24/7</p>
                            </div>
                            ...
                            <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition">
                                ...
                                <p class="text-center font-semibold text-gray-700">Dokter Terpercaya</p>
                            </div>
                            ...
                            <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition">
                                ...
                                <p class="text-center font-semibold text-gray-700">Fitur Lengkap</p>
                            </div>
                            ...
                            <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition">
                                ...
                                <p class="text-center font-semibold text-gray-700">Data Aman</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white py-16 mt-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                    <h2 class="text-3xl font-bold text-gray-900 mb-4">Mengapa Memilih HealthCare?</h2>
                    <p class="text-xl text-gray-600">Platform kesehatan digital terlengkap dan terpercaya di Indonesia</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="text-center p-6">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 mb-2">Cepat & Mudah</h3>
                        <p class="text-gray-600">Akses layanan kesehatan hanya dengan beberapa klik</p>
                    </div>
                    ...
                    <div class="text-center p-6">
                        ...
                        <p class="text-gray-600">Layanan kesehatan berkualitas dengan harga yang bersahabat</p>
                    </div>
                    ...
                    <div class="text-center p-6">
                        ...
                        <p class="text-gray-600">Data kesehatan Anda dilindungi dengan enkripsi tingkat tinggi</p>
                    </div>
                </div>
            </div>
        </div>
