...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-blue-400 text-sm font-semibold leading-5 text-white focus:outline-none focus:border-blue-300 transition duration-150 ease-in-out'
