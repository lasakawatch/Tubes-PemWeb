            ...
            <div class="space-y-6">
                ...
                <div class="bg-gray-800 rounded-xl p-6 border border-gray-700">
                    ...
                    <div x-data="{ preview: '{{ $product->image ? Storage::url($product->image) : '' }}' }">
                        ...
                        @if($product->image)
                            <p class="mt-2 text-xs text-gray-500">Gambar saat ini akan diganti jika upload baru</p>
                        @endif
                        @error('image')
                ...
                <div class="bg-gray-800 rounded-xl p-6 border border-gray-700 space-y-3">
                    ...
                    <a href="{{ route('admin.products.show', $product) }}" 
                       class="w-full inline-flex items-center justify-center px-6 py-3 bg-gray-700 hover:bg-gray-600 text-white rounded-lg font-medium transition-colors">
